...
<body>
				...
				<div class="card mb-4">
					...
					<div class="card-body">
						...
						<form action="<?= base_url('admin/caraousel/simpan') ?>" method="post"
							...
							<!-- Input judul -->
							<div class="mb-3">
								<label for="judul" class="form-label">Judul Caraousel</label>
	...
	<div class="col-md-12 mb-3 mt-3">
		<div class="card h-100">
			<img class="card-img-top" src="<?= base_url('template/upload/caraousel/'.$aa['foto'])?>">
			<div class="card-body">
				<h5 class="card-title"><?= $aa['judul']?></h5>
				<a class="me-3" href="<?= site_url('admin/caraousel/hapus/' . $aa['foto']); ?>" title="Delete">
